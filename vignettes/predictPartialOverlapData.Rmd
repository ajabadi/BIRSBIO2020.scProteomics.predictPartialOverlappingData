...
subtitle: ""
author: Chen Meng [mengchen18@gmail.com]
date: "`r format(Sys.time(), '%d %B, %Y')`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Predicting the missing samples or features in partially overlapping data}
...
![](../inst/images/overlapingSample.png)
...
![](../inst/images/overlappingFeature.png)
...
Download the data used in this analysis using the link below and put the data in the right place. I put it the "~/GitHub/data/" folder. 
...
load("~/GitHub/data/masstagSCE.rda")
